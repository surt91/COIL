...
defineCharm({
  ...
  text: 'Coils up to 18 tiles hold and every coil and wrap crushes +1. But your bites never knock back or interrupt.',
...
defineCharm({
  id: 'constrictor', name: "Constrictor's Ring", pool: 'common', glyph: 'muscle', color: '#c77dff',
...
defineCharm({ id: 'wide-coils', name: 'Wide Coils', pool: 'common', glyph: 'python', color: '#9b5de5', text: 'Coils up to 16 tiles hold.', coilAreaBonus: 4 });
defineCharm({
...
defineCharm({
  id: 'mongoose-tooth', name: 'Mongoose Tooth', pool: 'boss', glyph: 'fang', color: '#c9a66b',
...
defineCharm({ id: 'crushing-coils', name: 'Crushing Coils', pool: 'boss', glyph: 'muscle', color: '#9b5de5', text: 'Coils and wraps crush +1 and wrap needs one tile less. But your bites never interrupt.', crushBonus: 1, wrapBonus: 1, noInterrupt: true });
defineCharm({
